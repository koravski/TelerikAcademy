namespace ConvertTextToXml
{
    ...
    internal class Program
    {
        ...
        private static IEnumerable<Person> ExtractSubscribers(string fileData)
        {
            ...
            return splittedFileData.Select(line => line.Split(new[] {'|'}, StringSplitOptions.RemoveEmptyEntries).Select(p => p.Trim()).ToArray()).Select(person => new Person
            {
                Name = person[0], City = person[1], PhoneNumber = person[2]
            }).ToList();
        }
